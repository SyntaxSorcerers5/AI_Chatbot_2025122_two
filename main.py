...
from nltk_utils import tokenize, preprocess_input, fuzzy_match_with_synonyms
...
model_data = torch.load('data.pth', weights_only=True)
...
class PDF(FPDF):
    ...
    def generate_pdf_report(conversation, first_aid_info, user_details=None, location=None, emergency_contact=None,
        ...
        font_dir = r"C:\Users\Kasthuri\PycharmProjects\CHATBOT01\dejavu-fonts-ttf-2.37.tar.bz2"  # Adjust this path if needed
        ...
        # pdf.add_frame()
        pdf.rect(x=10, y=10, w=190, h=277)  # Create a border for the page
    ...
    # def generate_pdf_report(self, conversation, first_aid_info, user_details=None, location=None, emergency_contact=None, firstaid_provided=False, pdf_output_path="report.pdf"):
    #     pdf = FPDF()
    #     pdf.set_auto_page_break(auto=True, margin=15)
    #     pdf.add_page()
    #
    #     font_dir = r"C:\Users\Kasthuri\PycharmProjects\CHATBOT01"
    ...
    #     pdf.set_font("DejaVu", size=12)
    #     if user_details:
    #         pdf.multi_cell(0, 10, txt=f"Name: {user_details.get('name', 'N/A')}\nAge: {user_details.get('age', 'N/A')}\nGender: {user_details.get('gender', 'N/A')}")
    #     else:
    #         pdf.multi_cell(0, 10, txt="No details provided.")
    #
    #     pdf.ln(5)
    #
    #     pdf.set_font("DejaVu", style="B", size=12)
    ...
    #     pdf.set_font("DejaVu", size=12)
    #     if location:
    #         pdf.multi_cell(0, 10, txt=f"Location: {location}")
    #     else:
    #         pdf.multi_cell(0, 10, txt="Location not provided.")
    #     pdf.ln(5)
    #
    #     pdf.set_font("DejaVu", style="B", size=12)
    #     pdf.cell(200, 10, txt="Emergency Contact", ln=True)
    #     pdf.set_font("DejaVu", size=12)
    #     if emergency_contact:
    #         pdf.multi_cell(0, 10, txt=f"Name: {emergency_contact.get('name', 'N/A')}\nPhone: {emergency_contact.get('phone', 'N/A')}")
    #     else:
    #         pdf.multi_cell(0, 10, txt="No emergency contact provided.")
    #     pdf.ln(5)
    #
    #     pdf.set_font("DejaVu", style="B", size=12)
    #     pdf.cell(200, 10, txt="First Aid Provided", ln=True)
    #     pdf.set_font("DejaVu", size=12)
    #     pdf.multi_cell(0, 10, txt=f"{'Yes' if firstaid_provided else 'No'}")
    #     pdf.ln(5)
    #
    #     pdf.set_font("DejaVu", style="B", size=12)
    #     pdf.cell(200, 10, txt="Chatbot's Summary", ln=True)
    #     pdf.set_font("DejaVu", size=12)
    #     pdf.multi_cell(0, 10, txt=summarize_conversation(conversation))
    #
    #     pdf.ln(10)
    #
    #     # First aid info
    #     pdf.set_font("DejaVu", style="B", size=12)
    #     pdf.cell(200, 10, txt="First Aid Information", ln=True)
    #     pdf.set_font("DejaVu", size=12)
    #     pdf.multi_cell(0, 10, txt=f"{first_aid_info}")
    #
    #     pdf.ln(5)
    #
    #     # Create a unique file name using timestamp
    ...
    while True:
        ...
        if msg.lower() in ["quit", "exit"]:
            ...
            pdf_output_path = generate_pdf_report(
                ...
                first_aid_info=first_aid_data,
                user_details=user_details,
                location=location,
                emergency_contact=emergency_contact,
                firstaid_provided=bool(first_aid_data),
            )
            print(f"PDF report generated at: {pdf_output_path}")
